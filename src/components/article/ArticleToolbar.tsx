...
function generateSummary(article: Article): string {
  return `**AI Summary — ${article.title}**\n\n${article.excerpt}\n\nThis article explores how ${article.subtitle.toLowerCase()} The narrative is structured around three axes: cultural identity, the tension between tradition and modernity, and the role of local communities as agents of change.\n\n**Key points:**\n- The historical context defines the aesthetic and political decisions of the topic.\n- Local and community voices are central to the conversation.\n- There is a productive tension between heritage preservation and the need for reinvention.\n\n---\n\n*⚠️ This summary was generated with artificial intelligence and may contain inaccuracies. We recommend reading the full article for a deeper understanding of the topic.*\n\n*Generated by CULTX · ${new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}*`;
}
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px", borderBottom: isCollapsed ? "none" : "1px solid var(--color-border)", backgroundColor: "var(--color-surface-raised)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "2px", flexShrink: 0 }}>
          ...
          {/* Download audio */}
          {!isGenerating && (
            <button type="button" onClick={handleDownloadAudio} aria-label="Download podcast" title="Download audio" style={{ ...iconBtn, padding: "4px" }}>
              <Download size={14} weight="thin" />
            </button>
          )}

          {/* Close */}
          <button type="button" onClick={onClose} aria-label="Close player" style={{ ...iconBtn, padding: "4px" }}>
      ...
      {!isCollapsed && (
        <div style={{ padding: "16px 20px 20px" }}>
          <p style={{ fontSize: "0.72rem", color: "var(--color-text-secondary)", margin: "0 0 3px" }}>CULTX · Mexican Culture</p>
          ...
          {isGenerating ? (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", padding: "12px 0 8px" }}>
              ...
              <p style={{ fontSize: "0.78rem", color: "var(--color-text-secondary)", margin: 0 }}>Generating audio…</p>
            </div>
          ) : (
            <>
              {/* Progress bar */}
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "20px" }}>
                <button type="button" onClick={() => { setProgress(0); setIsPlaying(false); }} aria-label="Restart" style={iconBtn}>
                ...
                <button type="button" aria-label="Volume" style={iconBtn}>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-1 py-3 border-y" style={{ borderColor: "var(--color-border)" }}>
          ...
          <button
            ...
            aria-label="Convert article to podcast"
